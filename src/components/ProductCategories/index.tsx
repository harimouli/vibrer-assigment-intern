...
const ProductCategories: React.FC = () => {
  ...
  return (
    <div className="product-categories-sections">
      <h1 className="product-categories-heading">Product Categories</h1>
      <Slider {...settings}>
        {ProductCategoriesItems.map((item, index) => (
          <ProductItem key={index} text={item.text} imageUrl={item.imageUrl} />
        ))}
      </Slider>
    </div>
  );
